...
class Net(Network):
    def __init__(self, noise_dim=3, dim=2):
        super().__init__(
...
class GeneratorTest(parameterized.TestCase, alf.test.TestCase):
    ...
    @parameterized.parameters(
        ...
        #dict(fullrank_diag_weight=.5, plr=1e-3, lr=1e-3, phs=20, psi=5), # .71
        #dict(fullrank_diag_weight=.5, plr=1e-3, lr=1e-3, phs=20, psi=5), # .71
        #dict(fullrank_diag_weight=.5, plr=1e-3, lr=1e-3, phs=20, psi=5), # .71
        #dict(fullrank_diag_weight=.5, plr=1e-3, lr=1e-3, phs=20, psi=5), # .71
        #dict(fullrank_diag_weight=.5, plr=1e-3, lr=1e-3, phs=20, psi=5), # .71
        ...
        #dict(fullrank_diag_weight=1, plr=1e-3, lr=1e-3, phs=20, psi=5, exact=True), # .71
        #dict(fullrank_diag_weight=1, plr=1e-3, lr=1e-3, phs=20, psi=5, exact=True), # .71
        #dict(par_vi='gfsf', functional_gradient=None),
        #dict(par_vi='gfsf', functional_gradient=None),
        #dict(par_vi='gfsf', functional_gradient=None),
        #dict(par_vi='gfsf', functional_gradient=None),
        #dict(par_vi='gfsf', functional_gradient=None),
        dict(par_vi='svgd', functional_gradient='rkhs', exact=True), )
